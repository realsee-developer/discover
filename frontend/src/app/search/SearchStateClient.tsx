    ...
    <div className="relative min-h-screen bg-cyber-gray-900 pb-24">
      <section className="relative overflow-hidden border-b border-cyber-gray-800 pt-28 pb-24">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6">
          ...
          <div className="mt-12">
            <div className="cyber-card-neon flex flex-col gap-6 rounded-3xl border border-cyber-gray-600 bg-cyber-gray-900/85 p-4 shadow-cyber-brand-500/20 sm:p-6">
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex flex-1 flex-col justify-between gap-4">
                            <div>
                              <div className="inline-flex items-center gap-2 rounded-full border border-cyber-brand-400/50 bg-cyber-brand-500/10 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.3em] text-cyber-brand-400">
                        ...
                        (_, i) => {
                          ...
                          return (
                            <button
                              key={pageNum}
                              type="button"
                              className={`cyber-focus inline-flex h-10 w-10 items-center justify-center rounded-full text-sm font-semibold transition-colors duration-300 focus-visible:text-cyber-brand-500 ${
                                page === pageNum
                                  ? "bg-cyber-brand-500/20 text-cyber-brand-500"
                                  : "text-cyber-gray-300 hover:text-cyber-brand-400 focus-visible:text-cyber-brand-400"
                              }`}
